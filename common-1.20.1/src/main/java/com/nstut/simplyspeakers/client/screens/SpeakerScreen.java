...
public class SpeakerScreen extends SimplySpeakersUiScreen {
    ...
    protected void init() {
        ...
        PacketRegistries.CHANNEL.sendToServer(new RequestPlaylistPacketC2S(blockEntityPos));
    }
    ...
    private void sendToServer(Object packet) {
        PacketRegistries.CHANNEL.sendToServer(packet);
    }
    ...
    private void selectAudio(AudioFileMetadata audio) {
        ...
        PacketRegistries.CHANNEL.sendToServer(new SelectAudioPacketC2S(blockEntityPos, audio.getUuid(), audio.getOriginalFilename()));
    }
    ...
    private void openUpload() {
        Services.CLIENT.openFileDialog("mp3,wav", file -> {
            ...
            PacketRegistries.CHANNEL.sendToServer(
