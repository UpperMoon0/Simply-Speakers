...
public class AudioListWidget extends ObjectSelectionList<AudioListWidget.AudioEntry> {
    ...
    public class AudioEntry extends ObjectSelectionList.Entry<AudioEntry> {
        ...
        @Override
        public void render(GuiGraphicsExtractor guiGraphics, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isHovering, float partialTicks) {
